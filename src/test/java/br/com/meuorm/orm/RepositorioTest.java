...
public class RepositorioTest {
	...
	public void setUp() {
		...
		new RepositorioImpl<Pessoa>(connection).deleteAll(Pessoa.class);
	}
	...
	public void testFindAll() throws SQLException, InstantiationException, IllegalAccessException,
		...
		Repositorio<Pessoa> repositorio = new RepositorioImpl<>(connection);
	...
	public void testCreate() throws IllegalArgumentException, IllegalAccessException {
		...
		Repositorio<Pessoa> query = new RepositorioImpl<>(connection);
